    ...
    <>
      ...
      >
        <div
          ...
          className="standing-grid-1 text-sm standing-grid-header"
        >
          <div></div>
          <div className="center-grid">Rank</div>
          <div className="standing-grid-name px-2">Name</div>
          <div className="center-grid">Points</div>
        </div>
        {paginatedData?.map((entry) => (
          ...
          >
            ...
            <div className="center-grid">{entry.rank}</div>
            <div className="table-name px-2">
              <Link
                to={`${
            ...
            <div className="center-grid">{entry.points}</div>
          </div>
        ))}
      </div>
